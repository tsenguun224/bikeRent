...
const MyGradientButton = (props) => {
	return (
		<TouchableOpacity onPress={props.onPress} style={[styles.btn, { width: props.width }]}>
			<LinearGradient
				style={[styles.linear, { borderWidth: props.borderWidth, borderColor: props.borderColor }]}
